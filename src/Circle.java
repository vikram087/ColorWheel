...
public class Circle extends Polygon
{
	...
	public void draw(int xCenter, int yCenter, Graphics2D g2)
	{
		...
		double sizeX = xCenter * 2 / 3;// 4/3 ratio from frame to arc
		double sizeY = yCenter * 2 / 3;
		...
		for (int rgb = 0; rgb <= maxWhite; rgb++)
		{
			...
			g2.fill(new Arc2D.Double(xCenter - sizeX / 2, yCenter - sizeY / 2, sizeX, sizeY, angle, addedAngle, Arc2D.PIE));
...
//		RadialGradientPaint gradient = new RadialGradientPaint((float) (xCenter - 100), (float) (yCenter - 100), 250,
//				fractions, colors);
//
//		// test
//		float[] fractionTest1 = new float[] { (float) 1 / 5, (float) 2 / 8 };
//		Color[] colorsTest1 = new Color[] { Color.GREEN, Color.CYAN };
//		RadialGradientPaint gradientTest1 = new RadialGradientPaint((float) (xCenter - 100), (float) (yCenter - 100),
//				250, fractionTest1, colorsTest1);
//
//		super.paintComponent(g);
//		g2.setPaint(gradient);
//		g2.setPaint(gradientTest1);
//	    g2.fillArc(xCenter - 100, yCenter - 100, 200, 200, 0, 120);
//	    g2.fillArc(xCenter - 100, yCenter - 100, 200, 200, 120, 120);
//	    g2.fillArc(xCenter - 100, yCenter - 100, 200, 200, 240, 120);	    
...
//					g.fillArc(xCenter - 100, yCenter - 100, 200, 200, angle, fixedAngle);
//				}
	//
//				// ORANGE
//				if (x == 1)
...
//				g2.fill(new Arc2D.Double(xCenter - 100, yCenter - 100, 200, 200, angle, 1/(Math.pow(2, 24)), Arc2D.PIE));
