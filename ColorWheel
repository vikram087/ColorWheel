	 ...
	 public void paintComponent(Graphics g)
	  {
		...
		float[] fractions = new float[] {(float)1/5, (float)2/7, (float)3/7, (float)4/7, (float)5/7, (float)6/7, (float)1};
		Color[] colors = new Color[] {Color.GREEN, Color.CYAN, Color.BLUE, Color.MAGENTA, Color.RED, Color.ORANGE, Color.YELLOW};
